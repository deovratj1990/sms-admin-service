...
public interface SocietyRepository extends CrudRepository<Society, Integer>, SocietyRepositoryCustom {
	...
	@Query(value = "select s.society_name, l.locality_name, p.pincode_name, sp.subscription_period_start_date, sp.subscription_period_end_date,"
			...
			+ " and sp.subscription_period_end_date = ("
				+ "select max(sp.subscription_period_end_date)"
